                                ...
                                <div class="login-form-container">
                                    <div class="login-form">
                                        <form action="#" method="post">
											...
											<input type="password" name="user-password3" placeholder="Password3">
											...
											if (isset($_POST['update'])) {
												...
												$pass3 = $_POST['user-password3'];
													if($kqcheck['pass'] != $pass){
														echo '<h6 style="color:red; padding:10px 0px;">Mat khau khong dung</h4>';
													}
													if($pass2 != $pass3){
														echo '<h6 style="color:red; padding:10px 0px;">Hai mat khau khong trung nhau</h4>';
													}else{
														...
														$kqupdate = $conn -> query($sqlupdate);
															if($kqupdate){
																	echo '<h6 style="color:red; padding:10px 0px;">doi thanh cong</h4>';
																}else{
																	echo 'loi';
																}
													}
