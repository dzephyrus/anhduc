...
?>               
  ...
  <tbody>
	...
	<tr>
		...
		<td><button type="button" class="btn btn-primary text-light"> <a class="text-light" href="suasanpham1.php?id=<?=$row['id_p']?>">Update</a> </button>
		<button type="button" class="btn btn-danger text-light" onclick="return confirm('chấp nhận xóa')"> <a href="xoasanpham.php?id=<?=$row['id_p']?>" class="text-light">xóa</a> </button>
		</td>
	</tr>
	<?php
		}
